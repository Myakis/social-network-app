...
import Preloader2 from 'components/Preloader/v2'
...
export const ProfileDecription: FC<IProfileProps> = ({
  profile,
  setEditMode,
  isOwer,
}) => {
  return (
    <>
      ...
      {profile.lookingForAJob && (
        <div className={classes.itemDescr}>
          <span> Профессиональные скиллы:</span>{' '}
...
export const FormDescription: FC<any> = ({
  setEditMode,
  profile,
  saveData,
  ...props
